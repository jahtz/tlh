...
import {tlhTransliterationEditorConfig} from './editorConfig/tlhTransliterationEditorConfig';
...
export function writeXml(node: XmlElementNode, editorConfig: XmlEditorConfig = tlhTransliterationEditorConfig): string {
...
export function DocumentEditor<T>({node: initialNode, download, filename, closeFile, autoSave}: IProps): JSX.Element {
  ...
  const editorConfig = tlhTransliterationEditorConfig;
