...
function NoteNodeEditor({node, updateEditedNode, setKeyHandlingEnabled}: XmlEditableNodeIProps): JSX.Element {
    ...
    <>
      ...
      <div className="mb-4">
        ...
        <input type="text" id="content" className="mt-2 p-2 rounded border border-slate-500 w-full" placeholder={t('content') || 'content'}
               defaultValue={node.attributes.c} onFocus={() => setKeyHandlingEnabled(false)}
