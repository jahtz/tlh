...
describe('The transliteration parser should parse lines', () => {
  ...
  test.each<TestData>([
    {
      toParse: '1\' # [(x)] x ⸢zi⸣ x [',
      expected: lineParseResult('1\'', [w(del_in, us, aoIllegibleContent, ue, del_fin), w(aoIllegibleContent), w(laes_in, 'zi', laes_fin), w(aoIllegibleContent), w(del_in)])
    },
    {
      toParse: '2\' # [DUMU?].MUNUS?-ma e-ša-⸢a⸣-[ri',
      expected: lineParseResult('2\'', [w(del_in, sg('DUMU', uc, del_fin, '.', 'MUNUS', uc), '-ma'), w('e-ša-', laes_in, 'a', laes_fin, '-', del_in, 'ri')])
    },
    {
      toParse: '3\' # az-zi-ik-ki-it-[tén',
      expected: lineParseResult('3\'', [w('az-zi-ik-ki-it-', del_in, 'tén')])
    },
    {
      toParse: '4\' # nu ḫu-u-ma-an az-[zi-ik-ki- ¬¬¬',
      expected: lineParseResult('4\'', [w('nu'), w('ḫu-u-ma-an'), w('az-', del_in, 'zi-ik-ki-'), w(/*paragraphSeparator*/)])
    },
    {
      toParse: '5\' # [k]u-it-ma-an-aš-ma x [',
      expected: lineParseResult('5\'', [w(del_in, 'k', del_fin, 'u-it-ma-an-aš-ma'), w(aoIllegibleContent), w(del_in)])
    },
    {
      toParse: '6\' # [n]a-aš-kán GIŠ.NÁ [',
      expected: lineParseResult('6\'', [w(del_in, 'n', del_fin, 'a-aš-kán'), w(sg('GIŠ', '.', 'NÁ')), w(del_in)])
    },
    {
      toParse: '7\' # [nu-u]š-ši ša-aš-t[a-',
      expected: lineParseResult('7\'', [w(del_in, 'nu-u', del_fin, 'š-ši'), w('ša-aš-t', del_in, 'a-')])
    },
    {
    ...
    },
    {
      ...
      expected: lineParseResult('9\'', [w(del_in, 'nu-u', del_fin, 'š-ši'), w('im-ma', us, '-', ue, del_in)])
    },
    {
      toParse: '10\' # [x-x]-TE°MEŠ° ⸢e⸣-[',
      expected: lineParseResult('10\'', [w(del_in, 'x-x', del_fin, ag('-', 'TE'), dt('MEŠ')), w(laes_in, 'e', laes_fin, '-', del_in)])
    },
    {
      toParse: '11\' # [x (x)]-ri-⸢ia⸣-[ ¬¬¬',
      expected: lineParseResult('11\'', [w(del_in, aoIllegibleContent), w(us, aoIllegibleContent, ue, del_fin, '-ri-', laes_in, 'ia', laes_fin, '-', del_in), w(/*paragraphSeparator*/)])
    },
    {
      toParse: '12\' # [x x] x [',
      expected: lineParseResult('12\'', [w(del_in, 'x'), w('x', del_fin), w(aoIllegibleContent), w(del_in)])
    },
    {
      toParse: '1\' # [ … ] x ¬¬¬',
      expected: lineParseResult('1\'', [w(del_in), w(aoEllipsis), w(del_fin), w(aoIllegibleContent), w(/*paragraphSeparator*/)])
    },
    {
      toParse: '2\' # [ … °MUNUS.MEŠ°zi-i]n-tu-ḫi-e-eš',
      expected: lineParseResult('2\'', [w(del_in), w(aoEllipsis), w(dt('MUNUS.MEŠ'), 'zi-i', del_fin, 'n-tu-ḫi-e-eš')])
    },
    {
      toParse: '3\' # [ … -i]a-u-an-zi tar-kum-mi-ia-iz-zi ¬¬¬',
      expected: lineParseResult('3\'', [w(del_in), w(aoEllipsis), w('-i', del_fin, 'a-u-an-zi'), w('tar-kum-mi-ia-iz-zi'), w(/*paragraphSeparator*/)])
    },
    {
      toParse: '4\' # [ … °G]IŠ°BANŠUR °GIŠ°BANŠUR an-da',
      expected: lineParseResult('4\'', [w(del_in), w(aoEllipsis), w(dt('G', del_fin, 'IŠ'), ag('BANŠUR')), w(dt('GIŠ'), sg('BANŠUR')), w('an-da')])
    },
    {
      toParse: '5\' # [ … ] ⸢6⸣ NINDA.GUR₄.RA°ḪI.A° ki-an-da',
      expected: lineParseResult('5\'', [w(del_in), w(aoEllipsis), w(del_fin), w(laes_in, nc('6'), laes_fin), w(sg('NINDA', '.', 'GUR', id(4), '.', 'RA'), dt('ḪI.A')), w('ki-an-da')])
    },
    {
      toParse: '6\' # [ … -t]i-ia še-er pé-ra-an da-a-i ¬¬¬',
      expected: lineParseResult('6\'', [w(del_in), w(aoEllipsis), w('-t', del_fin, 'i-ia'), w('še-er'), w('pé-ra-an'), w('da-a-i'), w(/*paragraphSeparator*/)])
    },
    {
      toParse: '7\' # [ … pé-r]a-an ḫu-u-wa-a-i',
      expected: lineParseResult('7\'', [w(del_in), w(aoEllipsis), w('pé-r', del_fin, 'a-an'), w('ḫu-u-wa-a-i')])
    },
    {
    ...
    },
    {
      ...
      expected: lineParseResult('9\'', [w(del_in, 'ú-wa-an-zi'), w(aoEllipsis), w('k', del_fin, 'i', uc, '-an-ta'), w(/*paragraphSeparator*/)])
    },
    {
      toParse: '10\' # [ … ] x-zi ¬¬¬',
      expected: lineParseResult('10\'', [w(del_in), w(aoEllipsis), w(del_fin), w('x-zi'), w(/*paragraphSeparator*/)])
    },
    {
      toParse: '11\' # [ … ]-da',
      expected: lineParseResult('11\'', [w(del_in), w(aoEllipsis), w(del_fin, '-da')])
    },
    {
      toParse: '12\' # [ … °LÚ°ALAM.Z]U₉',
      expected: lineParseResult('12\'', [w(del_in), w(aoEllipsis), w(dt('LÚ'), sg('ALAM', '.', 'Z', del_fin, 'U', id(9)))])
    },
    {
      toParse: '13\' # [ … -z]i ¬¬¬',
      expected: lineParseResult('13\'', [w(del_in), w(aoEllipsis), w('-z', del_fin, 'i')], paragraphSeparator)
    },
    {
      toParse: '1\' # [x x] x x [ ¬¬¬',
      expected: lineParseResult('1\'', [w(del_in, aoIllegibleContent), w(aoIllegibleContent, del_fin), w(aoIllegibleContent), w(aoIllegibleContent), w(del_in)], paragraphSeparator)
    },
    {
      toParse: '2\' # LUGAL-uš GUB-[aš',
      expected: lineParseResult('2\'', [w(sg('LUGAL'), '-uš'), w(sg('GUB'), '-', del_in, 'aš')])
    },
    {
      toParse: '3\' # °D°UTU °D°U ⸢°D°⸣[',
      expected: lineParseResult('3\'', [w(dt('D'), sg('UTU')), w(dt('D'), sg('U')), w(laes_in, dt('D'), laes_fin, del_in)])
    },
    {
      toParse: '4\' # °D°zi-in-t[u-ḫi ¬¬¬',
      expected: lineParseResult('4\'', [w(dt('D'), 'zi-in-t', del_in, 'u-ḫi')], paragraphSeparator)
    },
    {
    ...
    },
    {
      ...
      expected: lineParseResult('6\'', [w(sg('LUGAL'), '-i'), w('pa-a-i'), w(sg('LUGAL'), '-u', del_in, 'š'), w('pár-ši-ia', del_fin)], paragraphSeparator)
    },
    {
      toParse: '7\' # ta-aš-ta °MUNUS.MEŠ°zi-[in-tu-ḫi-e-eš',
      expected: lineParseResult('7\'', [w('ta-aš-ta'), w(dt('MUNUS.MEŠ'), 'zi-', del_in, 'in-tu-ḫi-e-eš')])
    },
    {
      toParse: '8\' # pa-ra-a [ ¬¬¬',
      expected: lineParseResult('8\'', [w('pa-ra-a'), w(del_in), w(/*paragraphSeparator*/)])
    },
    {
      toParse: '9\' # pár-aš-na-a-u-<aš>-kán °LÚ°SAG[I.A ¬¬¬',
      expected: lineParseResult('9\'', [w('pár-aš-na-a-u-', supS, 'aš', supE, '-kán'), w(dt('LÚ'), sg('SAG'), del_in, sg('I', '.', 'A'))], paragraphSeparator)
    },
    {
    ...
    },
    {
      ...
      expected: lineParseResult('11\'', [w('e-ku-zi'), w(sg('GIŠ')), w(laes_in, dt('D'), laes_fin, del_in, sg('INANNA'))], paragraphSeparator)
    },
    {
      toParse: '12\' # °LÚ°SAGI.A [1 NINDA.GUR₄.RA EM-ṢA]',
      expected: lineParseResult('12\'', [
    ...
    },
    {
      ...
      expected: lineParseResult('13\'', [w(sg('LUGAL'), '-i'), w('pa-a-i'), w(del_in, sg('LUGAL'), '-uš'), w('pár-ši-ia', del_fin)], paragraphSeparator)
    },
    {
    ...
    },
    {
      ...
      expected: lineParseResult('15\'', [w(dt('LÚ', '.', 'MEŠ'), sg('GA', del_in, 'LA'))], paragraphSeparator)
    },
    {
      toParse: '16\' # ⸢na-aš⸣-k[án',
      expected: lineParseResult('16\'', [w(laes_in, 'na-aš', laes_fin, '-k', del_in, 'án')])
    },
    {
    ...
    },
    {
      ...
      expected: lineParseResult('11', [w('lá'), w('tù-qá-ri-ba-am')
      ])
    },
    {
